...
func (op *Admin) Welcome() gin.HandlerFunc {
...
func (op *Admin) Register() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		ctx.JSON(http.StatusOK, gin.H{})
	}
}
...
// of the user
func (op *Admin) ProcessRegister() gin.HandlerFunc {
	return func(ctx *gin.Context) {
...
func (op *Admin) LoginPage() gin.HandlerFunc {
	return func(ctx *gin.Context) {
...
func (op *Admin) Dashboard() gin.HandlerFunc {
	return func(ctx *gin.Context) {
...
func (op *Admin) TourPackagePage() gin.HandlerFunc {
	return func(ctx *gin.Context) {
...
// func (op *Admin) ProcessTourPackage() gin.HandlerFunc {
// 	return func(ctx *gin.Context) {
// 		if err := ctx.Request.ParseForm(); err != nil {
// 			_ = ctx.AbortWithError(http.StatusBadRequest, gin.Error{Err: err})
// 		}
...
// func (op *Admin) PreviewTour() gin.HandlerFunc {
// 	return func(ctx *gin.Context) {
// 		cookieData := sessions.Default(ctx)
...
func (op *Admin) GetTourRequest() gin.HandlerFunc {
	return func(ctx *gin.Context) {
...
func (op *Admin) ListOperators() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		list, err := op.DB.ListOperators()
		if err != nil {
			_ = ctx.AbortWithError(http.StatusInternalServerError, gin.Error{Err: err})
			return

		}
		ctx.JSONP(http.StatusOK, gin.H{"operators": list})
	}
}
